...
ANK_SCRIPT_EVENT(event_load_city, value)
ANK_SCRIPT_EVENT(event_save_scenario, value)
ANK_SCRIPT_EVENT(event_load_scenario, value)
ANK_SCRIPT_EVENT(event_quicksave, value)
ANK_SCRIPT_EVENT(event_quickload, value)
