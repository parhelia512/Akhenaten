...
extern io_buffer* iob_bridge_part_grid;
extern io_buffer* iob_bridge_type_grid;
...
extern io_buffer* iob_wall_material_grid;
...
extern io_buffer* iob_invasion_runtime;
