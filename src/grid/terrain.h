...
enum e_terrain : uint32_t {
    ...
    TERRAIN_ROAD_BLOCKED = TERRAIN_NOT_CLEAR - TERRAIN_FLOODPLAIN - TERRAIN_ROAD,
    ...
    TERRAIN_IMPASSABLE_HYENA = TERRAIN_IMPASSABLE + TERRAIN_GARDEN + TERRAIN_GATEHOUSE - TERRAIN_FLOODPLAIN,
    ...
    TERRAIN_IMPASSABLE_ANTELOPE = TERRAIN_IMPASSABLE + TERRAIN_GARDEN + TERRAIN_GATEHOUSE - TERRAIN_FLOODPLAIN - TERRAIN_MARSHLAND,
};
