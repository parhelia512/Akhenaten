...
void js_register_ui_element_base(js_State *J) {
    ...
    js_newcconstructor(J, jsB_UIButton_call, jsB_UIButton_construct, (js_StringNode)ui::egeneric_button::skind()._get(), 0);
    js_defglobal(J, (js_StringNode)ui::egeneric_button::skind()._get(), JS_DONTENUM);
