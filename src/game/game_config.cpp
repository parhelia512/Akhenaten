...
namespace game_features {
    ...
    game_feature gameui_show_delivery_paths{ "gameui_show_delivery_paths", "#TR_CONFIG_SHOW_DELIVERY_PATHS", true };
    ...
    game_feature gameplay_change_hasanimals{ "gameplay_change_has_animals", "#TR_CONFIG_CITY_HAS_ANIMALS", true };
