...
enum e_pack {
    ...
    PACK_ENEMY_NUBIAN,
    PACK_ENEMY_PERSIAN,
    PACK_ENEMY_PHOENICIAN,
    PACK_ENEMY_ROMAN,
    PACK_ENEMY_SEAPEOPLE,
    ////
    PACK_EXPANSION,
    PACK_EXPANSION_SPR,
    //
    ...
    //
    PACK_TOMB_RAMSES,
    PACK_TOMB_RAMSES_FINAL,
    PACK_TOMB_SETI,
    PACK_TOMB_SETI_FINAL,
    PACK_TOMB_THUTMOS,
    PACK_TOMB_THUTMOS_FINAL,
    PACK_TOMB_TUTANKHAMUN,
    PACK_TOMB_TUTANKHAMUN_FINAL,
    //
    PACK_PYRAMID,
    PACK_BENT_PYRAMID,
    PACK_STEPPED_PYRAMID,
    PACK_MUDBRICK_PYRAMID,
    PACK_LIB_EXTRA,
    PACK_LIB_EXTRA_2,
    PACK_LIB_MAUS_CARRYOVER,
    PACK_LIB_MAUSOLEUM_0,
    PACK_LIB_MAUSOLEUM_1,
    PACK_LIB_MAUSOLEUM_2,
    PACK_SUN_TEMPLE_EXTRA,
    PACK_SUN_TEMPLE_1,
    PACK_SUN_TEMPLE_2,
    PACK_SUN_TEMPLE_3,
    //
...
//#define GROUP_BUILDING_CANAL PACK_TERRAIN, 9      // 19
...
// Empire-map city buildings: Pharaoh_General group 169 (empire_bits_00057..00073, 17 frames).
// Prefer empire_city_images paths in empire.js over these macros.
#define GROUP_EMPIRE_CITY PACK_GENERAL, 169
#define GROUP_EMPIRE_CITY_OFFSET_OURS 0
#define GROUP_EMPIRE_CITY_OFFSET_EGYPTIAN 6
...
// TEMP: worker walk until the real funeral pack id is found (RE).
...
// #define GROUP_BUILDING_TEMPLE_COMPLEX_MAIN PACK_TEMPLE_NILE, 1
// #define GROUP_BUILDING_TEMPLE_COMPLEX_ORACLE PACK_TEMPLE_NILE, 2
// #define GROUP_BUILDING_TEMPLE_COMPLEX_ALTAR PACK_TEMPLE_NILE, 3
//#define GROUP_BUILDING_TEMPLE_COMPLEX_FLOORING PACK_TEMPLE_NILE, 4
//#define GROUP_BUILDING_TEMPLE_COMPLEX_STATUE_1 PACK_TEMPLE_NILE, 5
//#define GROUP_BUILDING_TEMPLE_COMPLEX_STATUE_2 PACK_TEMPLE_NILE, 6
#define GROUP_BUILDING_TEMPLE_COMPLEX_UPGRADES PACK_TEMPLE_NILE, 7
