...
enum e_debug_render {
    ...
    e_debug_render_sprite_frames = 11,
    e_debug_render_terrain_bits = 12,
    e_debug_render_image = 13,
    e_debug_render_image_alt = 14,
    e_debug_render_marshland = 15,
    e_debug_render_terrain_type = 16,
    e_debug_render_soil = 17,
    e_debug_render_unk_19 = 18,
    e_debug_render_tile_pos = 19,
    e_debug_render_floodplain_shore = 20,
    e_debug_render_tile_toph = 21,
    e_debug_render_monuments = 22,
    e_debug_render_figures = 23,
    e_debug_render_height = 24,
    e_debug_render_vegetation_growth = 25,
    e_debug_render_damage = 26,
    e_debug_render_desirability = 27,
    e_debug_render_river_shore = 28,
    e_debug_render_overall_entertainment = 29,
    e_debug_render_canals = 30,
    e_debug_render_overlay_add = 31,
    e_debug_render_gardens = 32,
    e_debug_render_routing_noncitizen = 33,
    e_debug_render_routing_amphibia = 34,
    e_debug_render_routing_water = 35,
    e_debug_render_invasion_point = 36,
    e_debug_render_tile_random = 37,
