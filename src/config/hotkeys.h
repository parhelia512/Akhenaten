...
enum e_hotkey_action {
    ...
    HOTKEY_BUILD_FIREHOUSE,
    HOTKEY_BUILD_ARCHITECT,
    HOTKEY_BUILD_APOTHECARY,
    HOTKEY_BUILD_GRANARY,
    HOTKEY_BUILD_STORAGE_YARD,
    HOTKEY_BUILD_BAZAAR,
    HOTKEY_BUILD_WALL,
    HOTKEY_BUILD_GATEHOUSE,
    HOTKEY_BUILD_WATERLIFT,
    HOTKEY_BUILD_CANAL,
    HOTKEY_BUILD_WATER_SUPPLY,
    ...
    // OG Cleopatra: Y / Z / H
    HOTKEY_SHOW_OVERLAY_MALARIA_RISK,
    HOTKEY_SHOW_OVERLAY_DISEASE,
    HOTKEY_SHOW_OVERLAY_HIDE_CLIFFS,
