log_info("akhenaten: figure birds_hunter started")
...
figure_birds_hunter {
	...
	sounds {
		hunter_investigate : {sound:"hunter_birds_investigate.wav", text: "#hunter_birds_investigate"}
		hunter_chase : {sound:"hunter_birds_chase.wav", text: "#hunter_birds_chase"}
		hunter_hunting : {sound:"hunt_bird_e01.wav", text: "#hunter_birds_hunting"}
		hunter_back : {sound:"hunt_bird_e02.wav", text: "#hunter_birds_back"}
		hunter_reroute_packed : {sound:"hunter_birds_reroute_packed.wav", text: "#hunter_birds_reroute_packed"}
		hunter_look_packed : {sound:"hunter_birds_look_packed.wav", text: "#hunter_birds_look_packed"}
		hunter_unloading : {sound:"hunter_birds_unloading.wav", text: "#hunter_birds_unloading"}
		hunter_disease_risk : {sound:"hunter_birds_disease_risk.wav", text: "#hunter_birds_disease_risk"}
		hunter_no_food_in_city : {sound:"hunter_birds_no_food_in_city.wav", text: "#hunter_birds_no_food_in_city"}
		hunter_city_have_no_army : {sound:"hunter_birds_city_have_no_army.wav", text: "#hunter_birds_city_have_no_army"}
		hunter_need_workers : {sound:"hunter_ostrich_need_workers.wav", text: "#hunter_ostrich_need_workers"}
		hunter_gods_are_angry : {sound:"hunter_birds_gods_are_angry.wav", text: "#hunter_birds_gods_are_angry"}
		...
		hunter_low_entertainment : {sound:"hunter_birds_low_entertainment.wav", text: "#hunter_birds_low_entertainment"}
		hunter_city_is_good : {sound:"hunter_birds_city_is_good.wav", text: "#hunter_birds_city_is_good"}
		hunter_city_is_amazing : {sound:"hunter_birds_city_is_amazing.wav", text: "#hunter_birds_city_is_amazing"}
	}
...
function figure_birds_hunter_gods_are_angry() {
...
function figure_birds_hunter_city_phrase_key() {
	var keys = []
	...
	if (figure_birds_hunter_gods_are_angry()) {
...
[es=(figure_birds_hunter, setup_phrase)]
function figure_birds_hunter_setup_phrase(ev) {
	...
	figure_apply_phrase(f, figure_birds_hunter_city_phrase_key())
}
