...
localization_en = [
     ...
     { key:"#TR_HOTKEY_SHOW_OVERLAY_MALARIA_RISK", text:"말라리아 위험 맵보기"},
     { key:"#TR_HOTKEY_SHOW_OVERLAY_DISEASE", text:"질병 맵보기"},
     { key:"#TR_HOTKEY_SHOW_OVERLAY_HIDE_CLIFFS", text:"절벽 숨기기"},
